...
help:
	...
	@echo "  VAR_DELAY - enable variable delay into read/write accesses, =_GDT_,_PWCLT106W85R_,_PWCLT400W200R_"
	@echo "           _GDT_ - Enable gaussian delay tables, should be configured as $LIME/shared/gdt_data_*.txt"
	@echo "           _PWCLT106W85R_ - Enable PwCLT based hardware RNG with 106ns write and 85ns read latency (DRAM)"
	@echo "           _PWCLT400W200R_ - Enable PwCLT based hardware RNG with 400ns write and 200ns read latency (DRAM)"
	@echo "  STD - Must be specified if VAR_DELAY is _PWCLT106W85R_ or _PWCLT400W200R_, =_MUDIVBY4_,_MUDIVBY8_,_MUDIVBY16_,_MUDIVBY32_"
