...
#if defined(USE_ACC)
#define CACHE_BARRIER {dre1.cache_flush(); dre1.cache_invalidate(); dre2.cache_flush(); dre2.cache_invalidate(); host::cache_flush_invalidate();}
#define CACHE_DISPOSE(p,n) {dre1.cache_invalidate(p,n); dre2.cache_invalidate(p,n); host::cache_invalidate(p,n);}
...
#if defined(USE_ACC)
#define CACHE_SEND_ALL {host::cache_flush(); /*dre1.cache_flush(); dre1.cache_invalidate(); dre2.cache_flush(); dre2.cache_invalidate();*/}
#define CACHE_RECV_ALL {/*dre1.cache_flush(); dre2.cache_flush();*/ host::cache_flush_invalidate();}
